    ...
    <section className="w-full flex justify-center items-center pt-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl px-4">
        {skills.map((skill) => (
          <div
            key={skill.title}
            className="bg-gray-hard bg-white/10 backdrop-blur-md border border-white/30 rounded-lg shadow-lg flex flex-col items-center p-8 text-center h-full min-h-[220px]"
          >
            <div className="mb-4">
